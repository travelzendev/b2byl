head.ready(function(){
    ...
    var cols2 = [
        {field:'order_num',title:'订单号',template:"#if(data.discount){ # <s class='discount-icon'>惠</s>  # } #<a target='_blank' href='yys13.html'>#= order_num #</a>"},
        ...
        {field:'psrinfo_status',title:'旅客资料',template:'<a href="yys17.html" target="_blank">#= psrinfo_status #</a>'},
        {field:'material_status',title:'实体资料',template:'<a href="yys18.html" target="_blank">#= material_status #</a>'},
